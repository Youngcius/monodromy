...
class NoBacksolution(Exception):
    """Signaled when the circuit backsolver can't find a suitable preimage
    point.

    Conjectured to be probabilistically meaningless: should be fine to
    re-run the call after catching this error.
    """
