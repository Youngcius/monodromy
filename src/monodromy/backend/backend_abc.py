...
class Backend(ABC):
    ...
    def volume(convex_polytope):  # ConvexPolytope -> PolytopeVolume
        ...
        Signals `NoFeasibleSolutions` if the ConvexPolytope has no
        solutions.
        """
        pass
    ...
    def reduce(convex_polytope):  # ConvexPolytope -> ConvexPolytope
        """Calculates a minimum set of inequalities specifying the
        ConvexPolytope.
    ...
    def triangulation(convex_polytope):  # ConvexPolytope -> List[List[int]]
        """Calculates a triangulation of the input ConvexPolytope.

        Returns a list of simplices, each specified as a list of its
        vertices, in turn each specified as the index into .vertices at
        which it appears.
        """
        pass
